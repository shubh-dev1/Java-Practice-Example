...
public class CoffeeVendingMachine {
  ...
  private void addRecipe(String name,int price,Map<String,Integer> recipe){
  ...
  public synchronized CoffeeRecipe selectRecipe(String coffeeName){
  ...
  public synchronized void dispenseCoffee(CoffeeRecipe coffeeRecipe,Payment payment){
    if(payment.getAmount()  < coffeeRecipe.getPrice()){
      throw new RuntimeException("Insufficient payment for "+ coffeeRecipe.getName() +". Required: "+ coffeeRecipe.getRecipe());
    }
    ...
    if(change > 0){
      System.out.println("Please collect your changes: $" + change);
    }
  }

  public void refillIngredients(String ingredient,int quantity){
